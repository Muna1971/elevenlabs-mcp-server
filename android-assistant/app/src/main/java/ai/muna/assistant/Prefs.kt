...
class Prefs(context: Context) {
    ...
    fun systemPrompt(): String {
        ...
        return base + "\n\n" +
            "أنت تُستخدمين كمساعدة صوتية على الهاتف. اجعلي ردودك مباشرة وقصيرة وصالحة " +
            "للنطق بصوت عالٍ، دون رموز أو تنسيقات. أجيبي بنفس لغة المستخدمة. " +
            "لديك أدوات للتحكم بالهاتف: فتح التطبيقات، خرائط جوجل، الاتصال، واتساب، التذكير، البحث. " +
            "عندما تطلب المستخدمة إجراءً على الهاتف، نفّذيه باستدعاء الأداة المناسبة فعليًا — " +
            "لا تقولي إنك ستفعلين شيئًا دون استدعاء الأداة. إن نقصت معلومة (مثل الوجهة على الخريطة " +
            "أو اسم جهة الاتصال) فاسأليها عنها بإيجاز، وبعد أن تجيب استدعي الأداة. " +
